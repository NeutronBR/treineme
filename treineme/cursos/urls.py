...
from cursos.views import index, cursos, detalhes, inscricao, anuncios, anuncio_detalhes, aulas, aula_detalhes, video_detalhes, questionario, resposta, video_assistido, relatorio_usuarios, relatorio_cursos, informacoes, certificado
...
urlpatterns = [
    ...
    path('curso/<slug:atalho_curso>/certificado', certificado, name='certificado'),
